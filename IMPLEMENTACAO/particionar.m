...
%% Particionamento da base de dados para a Validação Cruzada 
%   [ dadosParticionados, dadosNaiveBayesParticionados ] = 
%    particionar(dados, dadosNaiveBayes, numeroParticoes)
